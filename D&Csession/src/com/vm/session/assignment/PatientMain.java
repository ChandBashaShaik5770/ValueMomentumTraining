...
import com.vm.session.collection.Product;
...
public class PatientMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(getPatientAge("Sam",tm));
...
static int getPatientAge(String name,TreeMap tm)
{
	int age=0;
	Set<Integer> keys = tm.keySet();
	for( Integer key : keys )
	{	    
	    if( tm.get(key).equals(name))
	    {
	    	age=(int) tm.get(key);
	    }
	        //System.out.println("Key for value " + strValue + " is: " + key);
	        break;
	    }
